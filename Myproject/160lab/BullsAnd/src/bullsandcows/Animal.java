...
public Animal(String registrationNumber, String sireRegNum, String damRegNum, char gender, int month, int day, int year, String name, ClassificationScore classificationScore) {
...
public void createAnimal() {
   ...
   // ClassificationScore classificationScore = new ClassificationScore(1, 2, 2010, 30, 20, 20, 30);
    ...
    Animal animal = new Animal(registrationNumber, sireRegNum, damRegNum, gender, month, day, year,
 ...
 /**
     ...
     */
        ...
        Bull bull1 = new Bull("0001", "0002", "0003", 'm', 4, 8, 2000,
                "aBull", perfectBull, noProving);
        Bull bull2 = new Bull("0001", "0002", "0003", 'm', 4, 8, 2000,
                "anotherBull", nullBull, proving);
        Cow cow1 = new Cow("0001", "0002", "0003", 'f', 4, 8, 2000,
                "aCow", perfectCow, empty);
        Cow cow2 = new Cow("0001", "0002", "0003", 'f', 4, 8, 2000,
