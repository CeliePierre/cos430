...
public class Cow {
    ...
    private ArrayList<LoctationRecord> lacRecs;
        ...
        public Cow(String registrationNumber, String sireRegNum, String damRegNum, char gender, int month, int day, int year, String name, ClassificationScore classificationScore,
