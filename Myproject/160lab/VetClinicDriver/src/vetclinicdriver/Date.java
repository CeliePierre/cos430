 ...
 * 1..12. Day is validated based on the month that was set. dayNumber is the
 * number of elapsed days since January 1, 4712 BCE Java provides several date
 * classes that are more complicated than this one.
 *
 * @author aapplin
 */
public class Date implements Comparable {
    ...
    /**
     * Parameterized Constructor Validates Year, Month, and Day. Sets invalid
     * values to 1/1/1970 Calls: calcDayNumber() to set that property.
     *
    ...
    /**
     * Validates the month passed in. If the month is not valid it is set to 1.
     *
    ...
    /**
     * validates the day passed in from the constructor. Preconditions: The
     * month must already be validated for this to work.
     *
     ...
     * Only called by members of the class. Preconditions: month must be
     * validated and set before this is called. Thirty days hath September,
     * April, June, and November. All the rest have 31 excepting February alone
     * and it has 28 days clear and 29 on each leap year.
     *
     * @param day input integer for day
     ...
     * a list by the values in a Date object <br>
     *
