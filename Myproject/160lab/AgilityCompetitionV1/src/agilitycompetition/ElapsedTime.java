...
/**
 * Course: CSCI 160 Class: ElapsedTime Uses: nothing Extends: nothing
...
public class ElapsedTime implements Comparable {
     ...
     * objects belonging to some Java collection. Return values are dictated by
     * the interface (in the API) to be a negative number if this object is less
     * than that object (belongs before it) a zero if the two objects are equal
     * and a positive number if that object belongs after this object.
     *
