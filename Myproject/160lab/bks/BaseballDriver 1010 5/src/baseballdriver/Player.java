...
public abstract class Player implements Comparable<Player>{
    ...
    public String toString() {
     ...
     String positionName = Player.positionName[position];
    String handedness = throwsRightHanded ? "right-handed" : "left-handed";
    return String.format("%s (%d)\nPosition: %s\nThrows: %s\nPA: %d BB: %d SO: %d H: %d\n", playerName, playerNumber, positionName, handedness, plateAppearances, walks, strikeouts, hits);
}
