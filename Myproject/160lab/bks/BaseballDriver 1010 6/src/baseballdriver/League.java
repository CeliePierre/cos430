...
str.append("PA: ").append(rightieP.getPlateAppearances()).append(" BB: ").append(rightieP.getWalks()).append(" SO: ").append(rightieP.getStrikeouts()).append(" H: ").append(rightieP.getHits());
str.append(" IP: ").append(String.format("%d", rightieP.getInningsPitched())).append(" ER: ").append(rightieP.getEarnedRuns()).append(" ERA: ").append(String.format("%.2f", rightieP.getEarnedRunAverage()));
str.append(" WHIP: ").append(String.format("%.2f", rightieP.getWhip())).append(eol);
 ...
 str.append("PA: ").append(leftieP.getPlateAppearances()).append(" BB: ").append(leftieP.getWalks()).append(" SO: ").append(leftieP.getStrikeouts()).append(" H: ").append(leftieP.getHits());
str.append(" IP: ").append(String.format("%d", leftieP.getInningsPitched())).append(" ER: ").append(leftieP.getEarnedRuns()).append(" ERA: ").append(String.format("%.2f", leftieP.getEarnedRunAverage()));
str.append(" WHIP: ").append(String.format("%.2f", leftieP.getWhip())).append(eol);


PositionPlayer right = new PositionPlayer(1, "right", 0, true, totalPa, totalw, totalSo, totalH, totalAb, totalRbi, totalHr, totalHbp);
...
str.append(" BA: ").append(String.format("%.3f", right.getBattingAverage())).append(" OBP: ").append(String.format("%.3f", right.getOnBasePercentage())).append(eol);



PositionPlayer left = new PositionPlayer(1, "left", 0, false, totalPa, totalw, totalSo, totalH, totalAb, totalRbi, totalHr, totalHbp);
...
str.append("PA: ").append(left.getPlateAppearances()).append(" BB: ").append(left.getWalks()).append(" SO: ").append(left.getStrikeouts()).append(" H: ").append(left.getHits());
str.append(" AB: ").append(left.getAtBats()).append(" BI: ").append(left.getRunsBattedIn()).append(" HR: ").append(left.getHomeRuns()).append(" HBP: ")
  .append(left.getHitByPitch()).append(" BA: ").append(String.format("%.3f", left.getBattingAverage())).append(" OBP: ")
 .append(String.format("%.3f", left.getOnBasePercentage())).append(eol);
