...
public class Pitcher extends Player {
    ...
    if (inningsPitched > 0){
       era = (double) earnedRuns / inningsPitched * 27.0;
       whip = (double)(walks + hits)/inningsPitched * 3.0;
    }
}
 ...
 @Override
    public String toString() {
        ...
        str.append(String.format(" IP: %d %d/3 ER: %d ERA:",
               (inningsPitched/3), (inningsPitched%3), earnedRuns));
        if (inningsPitched > 0)
            str.append(String.format(" %.2f WHIP: %.2f", era, whip));
        else
            str.append(" n/a WHIP: n/a");
        return str.toString();
    }    /**
