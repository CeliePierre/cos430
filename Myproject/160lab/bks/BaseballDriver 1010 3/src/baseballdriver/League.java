...
public class League {
   ...
   // for(int team = 0; team < 2; team++) {
    ...
    public String calculateHandedness() {
        ...
        str.append("PA: ").append(leftPitcherPA).append(" BB: ").append(leftPitcherBB).append(" SO: ").append(leftPitcherSO).append(" H: ").append(leftPitcherH).append(" IP: ").append(leftPitcherIP).append(" ER: ").append(leftPitcherER)
                .append(" ERA: ").append(leftPitcherERA).append(" WHIP: ").append(leftPitcherWHIP).append(eol);
