...
#print_sorted_loop:
    ...
    # Calculate the address of the current item
    li $t2, 24  # Assuming each CartItem is 24 bytes (adjust if different)
    mul $t3, $t1, $t2  # Calculate offset for the current item
    ...
    # Print the price
    lw $a0, 20($t4)  # Assuming price is stored 20 bytes from the start
