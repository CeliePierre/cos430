...
/*<exercise chapter="A" section="10" type="programming" number="2">*/
...
public class Company {
    ...
    /*<exercise chapter="A" section="8" type="programming" number="2">*/
    /**
     * Determine if two Company objects are equal. Assume that the
     * Person object arrays are sorted by ID number.
     * @param other The other Company
     * @return true If the two Company object contain the same People
     */
    public boolean equals(Company other) {
        if (employees.length != other.employees.length) return false;
        for (int i = 0; i < employees.length; i++) {
            if (!employees[i].equals(other.employees[i])) return false;
        }
        return true;
    }
    /*</exercise>*/
    ...
    /*<exercise chapter="A" section="10" type="programming" number="2">*/
    public void readEmployees(BufferedReader br) {
        for (int i = 0; i < employees.length; i++) {
            employees[i] = Person.readPerson(br);
        }
    }
    /*</exercise>*/
}
