 ...
 * type safety I added The CmpCnt class is designed to keep track of the number
 * of comparisons performed I tested the compareTo() method of the Song class
 *
 * 9.2023 - Yusra Mugorewase i Compared two Song objects based on their artist's
 * name 9.2023 - Joel Kalala - I added the constructor, getter methods,
 * toString, compareTo, and javadoc. 8.2016 - Anne Applin - formatting and
 * JavaDoc skeletons added 2015 - Prof. Bob Boothe - Starting code and main for
 * testing
 *
 ************************************************************************
 */
...
public class Song implements Comparable {
    ...
    /**
     *
     * @author Yusra Mugorewase Compare two Song objects based on their artist's
     * name (case-insensitively).
     * @ param s1 The first song to be compared.
     * @ param s2 The second song to be compared.
     * @ return a negative integer, zero, or a positive integer if the artist of
     * the first song is lexicographically less than, equal to, or greater than
     * the artist of the second song.
     * @author Joelkalala The CmpCnt class is designed to keep track of the
     * number of comparisons performed. provides methods to retrieve and reset
     * the comparison count. Holds the count of comparisons made.
     * @ return the number of comparisons made. Reset the comparison count to
     * zero.
     */
    public static class CmpArtist implements Comparator<Song> {
        ...
        public int compare(Song s1, Song s2) {
            // System.out.println("Comparing " + s1.getArtist() + " with " + s2.getArtist());  // Logging comparison
         ...
         *
         * @param args
         * @author Joelkalala I tested the compareTo() method of the Song class
         * I tested the CmpArtist comparator class I Created a CmpArtist object
         * to compare songs by their artist
         */
public static void main(String[] args) {
        ...
        Song s3 = new Song("Professor B",
            ...
            System.out.println("Song1 vs Song2 = " + s1);
            System.out.println("Song2 vs Song1 = " + s2);
            System.out.println("Song1 vs Song3 = " + s1);
            System.out.println("Song3 vs Song1 = " + s3);
            System.out.println("Song1 vs Song1 = " + s1);

            System.out.println("\nTesting CmpArtist:");
            //CmpArtist artistComparator = new CmpArtist();

            Comparator<Song> artistComparator = new CmpArtist();
            //System.out.println("Testing CmpArtist:");
            System.out.println("Song1 vs Song2 (by artist) = " + s1.compareTo(s2));
            System.out.println("Song2 vs Song1 (by artist) = " + s2.compareTo(s1));
            System.out.println("Song1 vs Song3 (by artist) = " + s1.compareTo(s3));
            System.out.println("Song3 vs Song1 (by artist) = " + s3.compareTo(s1));
            System.out.println("Song1 vs Song1 (by artist) = " + s1.compareTo(s1));
