...
public class Song implements Comparable {
    ...
    public static class CmpArtist extends CmpCnt implements Comparator<Song> {
        ...
        public int compare(Song s1, Song s2) {
            cmpCnt++; // Increment the counter on each comparison
     ...
     *
     * @param args
     * @author Joelkalala I tested the compareTo() method of the Song class I
     * tested the CmpArtist comparator class I Created a CmpArtist object to
     * compare songs by their artist
     */
    public static void main(String[] args) {
       Song s1 = new Song("Professor B",
        ...
        System.out.println("Song1 vs Song2 (by artist) = " + artistComparator.compare(s1, s2));
        System.out.println("Song2 vs Song1 (by artist) = " + artistComparator.compare(s2, s1));
        System.out.println("Song1 vs Song3 (by artist) = " + artistComparator.compare(s1, s3));
        System.out.println("Song3 vs Song1 (by artist) = " + artistComparator.compare(s3, s1));
        System.out.println("Song1 vs Song1 (by artist) = " + artistComparator.compare(s1, s1));
